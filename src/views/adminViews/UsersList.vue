...
export default {
  ...
  methods: {
    ...
    deleteItemConfirm () {
      ...
      api.users.deleteUser(this.editedItem)
      this.closeDelete()
    },
    ...
    save () {
      if (this.editedIndex > -1) {
        ...
        api.users.updateUser(this.editedItem)
      } else {
        api.users.newUser(this.editedItem).then(response => (this.users.push(response.data)))
      }
      this.close()
    },
  },
